...
out_err_array = output_dir + "/layer_eval_conv_fc_err_array.npy"
out_std_array = output_dir + "/layer_eval_conv_fc_std_array.npy"

if not (os.path.exists(out_err_array) and os.path.exists(out_std_array)):
    err_array = np.zeros((len(bitwidth_list), 2, 5))
    std_array = np.zeros((len(bitwidth_list), 2, 5))
    ...
    for bitwidth_index in range(len(bitwidth_list)):
        ...
        std_array[bitwidth_index, 0, 0] = std.cpu().item()
        ...
        std_array[bitwidth_index, 0, 1] = std.cpu().item()
        ...
        std_array[bitwidth_index, 0, 2] = std.cpu().item()
        ...
        std_array[bitwidth_index, 0, 3] = std.cpu().item()
        ...
        std_array[bitwidth_index, 0, 4] = std.cpu().item()
        ...
        std_array[bitwidth_index, 1, 0] = std.cpu().item()
        ...
        std_array[bitwidth_index, 1, 1] = std.cpu().item()
        ...
        std_array[bitwidth_index, 1, 2] = std.cpu().item()
        ...
        std_array[bitwidth_index, 1, 3] = std.cpu().item()
        ...
        std_array[bitwidth_index, 1, 4] = std.cpu().item()
