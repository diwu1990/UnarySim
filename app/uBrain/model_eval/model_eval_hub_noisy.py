...
from UnarySim.app.uBrain.model.model_hub_noisy import Cascade_CNN_RNN
...
parser.add_argument('-tsp', '--threshold_sp', default=256., type=float, help=hpstr)

hpstr = "set output model directory"
# parser.add_argument('-odir', '--output_directory', default="/home/diwu/Project/uBrain/saved_model/mi/", type=str, help=hpstr) # mi
parser.add_argument('-odir', '--output_directory', default="/home/diwu/Project/uBrain/saved_model/sp/", type=str, help=hpstr) # sp
...
training_epochs= args.epoch if args.task_mi else 900
lr=args.lr
...
assert rnn_hard == True, "HUB inference should always applies HardMGU!"
