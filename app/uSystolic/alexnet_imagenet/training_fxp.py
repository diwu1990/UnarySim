...
from UnarySim.sw.app.uSystolic.alexnet_imagenet import alexnet_fxp
...
parser.add_argument('-bw', '--bitwidth', default=8, type=int, metavar='N',
                    help='fxp bitwidth in usystolic array')
